...
import { AttendenceformComponent } from './components/config/attendance/attendenceform/attendenceform.component';
import { HolydaysComponent } from './components/config/holydays/holydays/holydays.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'attendanceform', component: AttendenceformComponent },
      ...
      { path: 'holiday', component: HolydaysComponent }
    ]
  },
  {
